...
public:
	...
	/*
	void PrecacheModel(const char *modelName);
	void PrecacheSound(const char *attackSound, const char *damageSound, const char *deadSound);
	 */
...
#define DMG_CLUB			(1 << 7)	// knife, punch, headbutt
